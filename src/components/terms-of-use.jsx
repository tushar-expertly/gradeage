    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            The Gradeage website contains documents and resources contributed by
          ...
          <p className="mb-4">
            ...
            While we strive to ensure accuracy and currency, Gradeage does not
            guarantee the reliability or authenticity of third-party
            information. Gradeage disclaims any liability for actions taken
            based on the information presented, as well as any consequences
            arising from such actions.
          </p>
          <p className="mb-4">External Links</p>
          <p className="mb-4">
            Gradeage’s web portal may feature links to external websites managed
            ...
            imply endorsement of the external site or its content. Gradeage may
          ...
          <p className="mb-4">
            ...
            respective organizations. Gradeage is not responsible for the
