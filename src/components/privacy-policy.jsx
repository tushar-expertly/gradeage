    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            At Gradeage, we are dedicated to safeguarding your privacy and
            ...
            existing agreements directly established between you and Gradeage.
          ...
          <p className="mb-4">
            At Gradeage, we will only request personal information when it is
          ...
          <p className="mb-4">
            In the event that Gradeage invites you to complete and submit an
          ...
          <p className="mb-4">
            It's important to note that while Gradeage may track a visitor's
          ...
          <p className="mb-4">
            The purposes for which Gradeage may utilize your personal
          ...
          <p className="mb-4">
            If you wish to be removed from any Gradeage distribution list,
          ...
          <p className="mb-4">
            ...
            Gradeage, you may receive telephone calls from us regarding new
          ...
          <p className="mb-4">
            The Gradeage website may contain links to external websites,
            ...
            are not governed by Gradeage's privacy policy. Gradeage has no
          ...
          <p className="mb-4">
            ...
            Gradeage's privacy practices and does not extend to the privacy
            policies or practices of third-party websites or features. Gradeage
          ...
          <p className="mb-4">
            ...
            paramount at Gradeage. We have implemented robust measures to
          ...
          <p className="mb-4">
            At Gradeage, we remain committed to upholding the highest standards
          ...
          <p className="mb-4">
            ...
            Gradeage remains fully compliant with the EU-US Privacy Shield
          ...
          <p className="mb-4">
            At Gradeage, we are committed to maintaining the highest standards
          ...
          <p className="mb-4">
            Gradeage is mandated to adhere to specific procedures when
          ...
          <p className="mb-4">
            In accordance with the Privacy Shield Principles, Gradeage is
          ...
          <p className="mb-4">
            Gradeage is subject to the investigative and enforcement authority
          ...
          <p className="mb-4">
            Gradeage reserves the right to modify or supplement this Privacy
            Policy at its discretion. We encourage you to periodically review
            this section of Gradeage’s website to stay informed of any updates.
