        ...
        >
          ...
          {user ? (
            ...
            <>
              <Link
                to="/login"
                className="px-3 py-2 text-sm rounded-full font-bold text-white border-2  bg-orange-500 transition-all ease-in-out duration-300 hover:bg-orange-300 hover:text-[#007bff]"
              >
                Login
              </Link>
              <Link
