...
function Footer() {
  return (
    <section className="py-10 bg-orange-100 sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            <p className="text-base leading-relaxed text-gray-600 mt-7">
              ...
              services. Embracing continuous learning for success in dynamic
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
            ...
            <form className="mt-6 flex">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center px-2 py-2 ml-3 font-semibold text-white transition-all duration-200  bg-orange-500  rounded-md hover:bg-blue-700 focus:bg-blue-700"
              >
                Subscribe
              </button>
            </form>
        ...
        <p className="text-sm text-center text-gray-600">
          © Copyright 2024, All Rights Reserved by Gradeage
        </p>
      </div>
    </section>
  );
